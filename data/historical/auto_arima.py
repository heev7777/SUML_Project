def auto_arima():
    ...
    dataset_for_prediction['Mean'].plot(color='green', ax=ax)
    ax.legend(['Next day value', 'Mean'])
    ax.set_title('Tyson Opening Stock Value')
